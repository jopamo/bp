...
RDEPEND="
	>=dev-py/imageio-2.36[${PYTHON_USEDEP}]
	>=dev-py/lazy-loader-0.4[${PYTHON_USEDEP}]
	>=dev-pypi/networkx-3.0[${PYTHON_USEDEP}]
	>=dev-pypi/numpy-1.24[${PYTHON_USEDEP}]
	>=xgui-app/pillow-10.1[${PYTHON_USEDEP}]
	>=dev-py/scipy-1.11.4[sparse(+),${PYTHON_USEDEP}]
	>=dev-py/tifffile-2022.8.12[${PYTHON_USEDEP}]
"
DEPEND="
	${RDEPEND}
	dev-py/pythran[${PYTHON_USEDEP}]
"
BDEPEND="
...
#distutils_enable_sphinx doc/source dev-py/numpydoc dev-py/myst-parser
...
pkg_postinst() {
	optfeature "FITS io capability" dev-py/astropy
	optfeature "GTK" dev-py/pygtk
	optfeature "io plugin providing most standard formats" dev-py/imread
	optfeature "plotting" dev-pypi/matplotlib
	optfeature "wavelet transformations" dev-py/pywavelets
	optfeature "io plugin providing a wide variety of formats, including specialized formats using in medical imaging." dev-py/simpleitk
}
