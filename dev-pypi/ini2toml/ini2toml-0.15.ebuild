...
RDEPEND="
	>=dev-pypi/packaging-20.7[${PYTHON_USEDEP}]
	>=dev-pypi/setuptools-59.6[${PYTHON_USEDEP}]
	>=dev-pypi/tomli-w-0.4.0[${PYTHON_USEDEP}]
"
BDEPEND="
	dev-py/setuptools-scm[${PYTHON_USEDEP}]
	test? (
		dev-pypi/configupdater[${PYTHON_USEDEP}]
...
python_test() {
	...
	if ! has_version "<dev-py/pyproject-fmt-2[${PYTHON_USEDEP}]"; then
		EPYTEST_DESELECT+=(
