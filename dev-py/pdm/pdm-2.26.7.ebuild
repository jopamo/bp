...
RDEPEND="
	...
	dev-py/shellingham[${PYTHON_USEDEP}]
	dev-py/tomlkit[${PYTHON_USEDEP}]
	>=dev-py/truststore-0.10.4[${PYTHON_USEDEP}]
...
src_prepare() {
	...
	# dev-py/pdm-backend tests test the wrong package
