...
RDEPEND="
    ${DEPEND}
    >=dev-pypi/contourpy-1.0.1[${PYTHON_USEDEP}]
    >=dev-pypi/cycler-0.10.0-r1[${PYTHON_USEDEP}]
    >=dev-pypi/kiwisolver-1.3.1[${PYTHON_USEDEP}]
    >=dev-pypi/packaging-20.0[${PYTHON_USEDEP}]
    >=xgui-app/pillow-8[jpeg,webp,${PYTHON_USEDEP}]
    >=dev-pypi/pyparsing-2.3.1[${PYTHON_USEDEP}]
    >=dev-pypi/python-dateutil-2.7[${PYTHON_USEDEP}]
    >=dev-pypi/pytz-2019.3[${PYTHON_USEDEP}]
    cairo? ( dev-pypi/cairocffi[${PYTHON_USEDEP}] )
    excel? ( dev-py/xlwt[${PYTHON_USEDEP}] )
    gtk3? (
        >=dev-py/pygobject-3.40.1-r1:3[cairo?,${PYTHON_USEDEP}]
    )
    webagg? ( >=dev-pypi/tornado-6.0.4[${PYTHON_USEDEP}] )
"
...
BDEPEND="
    ...
    test? (
        ...
        >=dev-pypi/tornado-6.0.4[${PYTHON_USEDEP}]
    )
"
