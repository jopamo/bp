	...
	for var; do
		case "${var}" in
			...
			PYTHON_PKG_DEP)
				...
				case ${impl} in
					python*)
						PYTHON_PKG_DEP="app-lang/python:${impl#python}${PYTHON_REQ_USE:+[${PYTHON_REQ_USE}]}"
						;;
					pypy3.*)
						PYTHON_PKG_DEP="app-lang/pypy:${impl#pypy}=${PYTHON_REQ_USE:+[${PYTHON_REQ_USE}]}"
						;;
					*)
...
# @USAGE: <directory>
# @DESCRIPTION:
# Build HTML documentation using dev-pypi/sphinx in the specified
...
# on dev-pypi/pytest-timeout is added automatically.
...
# on dev-pypi/pytest-xdist is added automatically.
