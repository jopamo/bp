...
RDEPEND="
	>=dev-py/asgiref-3.4.0[${PYTHON_USEDEP}]
	>=dev-py/click-7.0[${PYTHON_USEDEP}]
	>=dev-py/h11-0.8[${PYTHON_USEDEP}]
"
BDEPEND="
	test? (
		dev-py/a2wsgi[${PYTHON_USEDEP}]
		>=dev-py/httptools-0.6.3[${PYTHON_USEDEP}]
		>=dev-py/httpx-0.28[${PYTHON_USEDEP}]
		dev-py/python-dotenv[${PYTHON_USEDEP}]
		dev-py/pyyaml[${PYTHON_USEDEP}]
		dev-py/typing-extensions[${PYTHON_USEDEP}]
		>=dev-py/websockets-10.4[${PYTHON_USEDEP}]
		dev-py/wsproto[${PYTHON_USEDEP}]
		test-rust? (
