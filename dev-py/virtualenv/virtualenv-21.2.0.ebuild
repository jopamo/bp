...
RDEPEND="
	>=dev-py/distlib-0.3.7[${PYTHON_USEDEP}]
	>=dev-py/filelock-3.20.1[${PYTHON_USEDEP}]
	>=dev-py/platformdirs-3.9.1[${PYTHON_USEDEP}]

	dev-py/ensurepip-pip
	>=dev-py/ensurepip-setuptools-70.1
...
BDEPEND="
	...
	test? (
		${RDEPEND}
		$(python_gen_cond_dep '
			dev-py/coverage[${PYTHON_USEDEP}]
			>=dev-py/pip-22.2.1[${PYTHON_USEDEP}]
