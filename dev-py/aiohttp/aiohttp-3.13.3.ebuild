...
RDEPEND="
	${DEPEND}
	>=dev-py/aiodns-3.3.0[${PYTHON_USEDEP}]
	>=dev-py/aiohappyeyeballs-2.5.0[${PYTHON_USEDEP}]
	>=dev-py/aiosignal-1.4.0[${PYTHON_USEDEP}]
	>=dev-py/attrs-17.3.0[${PYTHON_USEDEP}]
	>=dev-py/brotlicffi-1.2[${PYTHON_USEDEP}]
	>=dev-py/frozenlist-1.1.1[${PYTHON_USEDEP}]
	>=dev-py/multidict-4.5.0[${PYTHON_USEDEP}]
	>=dev-py/propcache-0.2.0[${PYTHON_USEDEP}]
	>=dev-py/yarl-1.17.0[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		dev-py/backports-zstd[${PYTHON_USEDEP}]
	' 3.11 3.12 3.13)
"
BDEPEND="
	>=dev-py/multidict-4.5.0[${PYTHON_USEDEP}]
