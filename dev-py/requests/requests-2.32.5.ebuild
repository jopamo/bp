...
RDEPEND="
	>=dev-py/certifi-2017.4.17[${PYTHON_USEDEP}]
	<dev-py/charset-normalizer-4[${PYTHON_USEDEP}]
	<dev-py/idna-4[${PYTHON_USEDEP}]
	<dev-py/urllib3-3[${PYTHON_USEDEP}]
	socks5? ( >=dev-py/pysocks-1.5.6[${PYTHON_USEDEP}] )
"

BDEPEND="
	test? (
		>=dev-py/pysocks-1.5.6[${PYTHON_USEDEP}]
		test-rust? (
...
python_test() {
	...
	if ! has_version "dev-py/trustme[${PYTHON_USEDEP}]"; then
		EPYTEST_DESELECT+=(
