...
RDEPEND="
	>=dev-py/packaging-24.0[${PYTHON_USEDEP}]
...
BDEPEND="
	...
	test? (
		${RDEPEND}
		$(python_gen_cond_dep '
			>=dev-py/filelock-3[${PYTHON_USEDEP}]
			dev-py/pytest[${PYTHON_USEDEP}]
			>=dev-py/pytest-mock-2[${PYTHON_USEDEP}]
			>=dev-py/pytest-rerunfailures-9.1[${PYTHON_USEDEP}]
			>=dev-py/pytest-xdist-1.34[${PYTHON_USEDEP}]
			>=dev-py/setuptools-56.0.0[${PYTHON_USEDEP}]
			>=dev-py/virtualenv-20.0.35[${PYTHON_USEDEP}]
			>=dev-py/wheel-0.36.0[${PYTHON_USEDEP}]
