...
RDEPEND="
	${DEPEND}
	>=dev-pypi/aiodns-3.3.0[${PYTHON_USEDEP}]
	>=dev-pypi/aiohappyeyeballs-2.5.0[${PYTHON_USEDEP}]
	>=dev-pypi/aiosignal-1.4.0[${PYTHON_USEDEP}]
	>=dev-pypi/attrs-17.3.0[${PYTHON_USEDEP}]
	>=dev-pypi/brotlicffi-1.2[${PYTHON_USEDEP}]
	>=dev-pypi/frozenlist-1.1.1[${PYTHON_USEDEP}]
	>=dev-pypi/multidict-4.5.0[${PYTHON_USEDEP}]
	>=dev-pypi/propcache-0.2.0[${PYTHON_USEDEP}]
	>=dev-pypi/yarl-1.17.0[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		dev-pypi/backports-zstd[${PYTHON_USEDEP}]
	' 3.11 3.12 3.13)
"
BDEPEND="
	>=dev-pypi/multidict-4.5.0[${PYTHON_USEDEP}]
	dev-py/pkgconfig[${PYTHON_USEDEP}]
	native-extensions? (
		>=dev-py/cython-3.1.1[${PYTHON_USEDEP}]
		dev-py/pkgconfig[${PYTHON_USEDEP}]
	)
	test? (
		dev-py/blockbuster[${PYTHON_USEDEP}]
		dev-pypi/freezegun[${PYTHON_USEDEP}]
		dev-py/isal[${PYTHON_USEDEP}]
		dev-py/re-assert[${PYTHON_USEDEP}]
		$(python_gen_cond_dep '
			dev-py/time-machine[${PYTHON_USEDEP}]
		' 'python3*')
		dev-py/zlib-ng[${PYTHON_USEDEP}]
