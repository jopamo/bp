...
SNAPSHOT=dce45bd6e99b1368b24c32325ed8ac8156e81766
...
BDEPEND="
	app-dev/pkgconf
	>=dev-pypi/cython-3.0.10[${PYTHON_USEDEP}]
	doc? (
		$(python_gen_any_dep '
			dev-pypi/docutils[${PYTHON_USEDEP}]
...
python_check_deps() {
	use doc || return 0
	python_has_version -b "dev-pypi/docutils[${PYTHON_USEDEP}]" &&
...
pkg_postinst() {
	...
	optfeature "Support for lxml.html.clean sanitizer" dev-pypi/lxml-html-clean
}
