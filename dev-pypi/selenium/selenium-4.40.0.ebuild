...
RDEPEND="
	>=dev-pypi/certifi-2026.1.4[${PYTHON_USEDEP}]
	>=dev-pypi/trio-0.31.0[${PYTHON_USEDEP}]
	>=dev-pypi/trio-websocket-0.12.2[${PYTHON_USEDEP}]
	>=dev-pypi/typing-extensions-4.15.0[${PYTHON_USEDEP}]
	>=dev-pypi/urllib3-2.6.0[${PYTHON_USEDEP}]
	>=dev-pypi/websocket-client-1.8.0[${PYTHON_USEDEP}]
"
BDEPEND="
	test? (
		${RDEPEND}
		$(python_gen_cond_dep "
			dev-py/filetype[\${PYTHON_USEDEP}]
