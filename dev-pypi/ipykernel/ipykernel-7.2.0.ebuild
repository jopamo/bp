...
RDEPEND="
	>=dev-pypi/comm-0.1.1[${PYTHON_USEDEP}]
	...
	>=dev-pypi/psutil-5.7[${PYTHON_USEDEP}]
	>=dev-pypi/pyzmq-25[${PYTHON_USEDEP}]
	>=dev-pypi/tornado-6.2[${PYTHON_USEDEP}]
	>=dev-pypi/traitlets-5.4.0[${PYTHON_USEDEP}]
"
