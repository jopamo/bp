...
RDEPEND="
	>=dev-pypi/coverage-7.10.6[${PYTHON_USEDEP}]
	>=dev-pypi/pluggy-1.2[${PYTHON_USEDEP}]
	>=dev-pypi/pytest-7[${PYTHON_USEDEP}]
"
# NB: xdist is also used directly in the test suite
BDEPEND="
	dev-pypi/hatch-fancy-pypi-readme[${PYTHON_USEDEP}]
	test? (
		dev-pypi/fields[${PYTHON_USEDEP}]
		>=dev-py/process-tests-2.0.2[${PYTHON_USEDEP}]
		>=dev-pypi/py-1.4.22[${PYTHON_USEDEP}]
