...
RDEPEND="
	>=dev-py/coverage-7.10.6[${PYTHON_USEDEP}]
	>=dev-py/pluggy-1.2[${PYTHON_USEDEP}]
	>=dev-py/pytest-7[${PYTHON_USEDEP}]
"
# NB: xdist is also used directly in the test suite
BDEPEND="
	dev-py/hatch-fancy-pypi-readme[${PYTHON_USEDEP}]
	test? (
		dev-py/fields[${PYTHON_USEDEP}]
		>=dev-py/process-tests-2.0.2[${PYTHON_USEDEP}]
		>=dev-py/py-1.4.22[${PYTHON_USEDEP}]
