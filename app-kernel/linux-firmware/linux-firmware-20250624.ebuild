...
SNAPSHOT=b05fabcd6f2a16d50b5f86c389dde7a33f00bb81
SRC_URI="https://gitlab.com/kernel-firmware/linux-firmware/-/archive/${SNAPSHOT}/linux-firmware-${SNAPSHOT}.tar.bz2 -> linux-firmware-${SNAPSHOT}.tar.bz2"
