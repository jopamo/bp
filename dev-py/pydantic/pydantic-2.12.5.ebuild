...
RDEPEND="
	>=dev-py/annotated-types-0.6.0[${PYTHON_USEDEP}]
	>=dev-py/typing-extensions-4.14.1[${PYTHON_USEDEP}]
	>=dev-py/typing-inspection-0.4.2[${PYTHON_USEDEP}]
	dev-py/tzdata[${PYTHON_USEDEP}]
	!dev-py/pydantic-core
"
BDEPEND="
	>=dev-py/hatch-fancy-pypi-readme-22.5.0[${PYTHON_USEDEP}]
	dev-util/maturin[${PYTHON_USEDEP}]
	test? (
		$(python_gen_cond_dep '
			dev-py/cloudpickle[${PYTHON_USEDEP}]
		' 'python3*')
		dev-py/dirty-equals[${PYTHON_USEDEP}]
		>=dev-py/email-validator-2.0.0[${PYTHON_USEDEP}]
		>=dev-py/faker-18.13.0[${PYTHON_USEDEP}]
		>=dev-py/jsonschema-4.23.0[${PYTHON_USEDEP}]
		dev-py/pytz[${PYTHON_USEDEP}]
		dev-py/rich[${PYTHON_USEDEP}]
	)
"
# pydantic-core
BDEPEND+="
	test? (
		>=dev-py/dirty-equals-0.5.0[${PYTHON_USEDEP}]
		>=dev-py/inline-snapshot-0.13.3[${PYTHON_USEDEP}]
...
python_test() {
	...
	if ! has_version "dev-py/cloudpickle[${PYTHON_USEDEP}]"; then
		EPYTEST_IGNORE+=(
			# (pydantic)
