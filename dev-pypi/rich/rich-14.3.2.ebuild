...
RDEPEND="
	...
	>=dev-pypi/markdown-it-py-2.2.0[${PYTHON_USEDEP}]
	>=dev-pypi/pygments-2.13.0[${PYTHON_USEDEP}]
"
BDEPEND="
	test? (
		>=dev-pypi/attrs-21.4.0[${PYTHON_USEDEP}]
	)
"
...
pkg_postinst() {
	optfeature "integration with HTML widgets for Jupyter" dev-pypi/ipywidgets
}
