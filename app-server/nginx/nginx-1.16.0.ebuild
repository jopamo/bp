...
CDEPEND="
	...
	http2? ( >=lib-dev/libressl-1.0.1c:0= )
	http-cache? ( lib-dev/libressl:0= )
	...
	nginx_modules_http_gzip? ( lib-sys/zlib )
	nginx_modules_http_gzip_static? ( lib-sys/zlib )
	nginx_modules_http_image_filter? ( lib-media/gd:=[jpeg,png] )
	nginx_modules_http_perl? ( >=dev-lang/perl-5.8:= )
	nginx_modules_http_rewrite? ( lib-dev/libpcre:= )
	nginx_modules_http_secure_link? ( lib-dev/libressl:0= )
	...
	nginx_modules_http_metrics? ( lib-dev/yajl:= )
	nginx_modules_http_dav_ext? ( lib-dev/expat )
