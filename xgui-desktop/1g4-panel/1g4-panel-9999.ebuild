...
DESCRIPTION="a panel"
HOMEPAGE="https://github.com/1g4linux/1g4-panel"

if [[ ${PV} != 9999 ]]; then
	SNAPSHOT=ad4f8dd1608681705c890ed1bb921b843a9396cf
	SRC_URI="https://github.com/1g4linux/1g4-panel/archive/${SNAPSHOT}.tar.gz -> ${PN}-${SNAPSHOT}.tar.gz"
	S="${WORKDIR}/1g4-panel-${SNAPSHOT}"
else
	WANT_LIBTOOL=none
	inherit git-r3
	EGIT_REPO_URI="https://github.com/1g4linux/1g4-panel.git"
fi
