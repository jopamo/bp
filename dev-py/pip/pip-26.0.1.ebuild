...
# please bump dev-py/ensurepip-pip along with this package!
...
RDEPEND="
	>=dev-py/cachecontrol-0.14.3[${PYTHON_USEDEP}]
	>=dev-py/dependency-groups-1.3.0[${PYTHON_USEDEP}]
	>=dev-py/distlib-0.4.0[${PYTHON_USEDEP}]
	>=dev-py/distro-1.9.0[${PYTHON_USEDEP}]
	>=dev-py/msgpack-1.1.1[${PYTHON_USEDEP}]
	>=dev-py/packaging-25.0[${PYTHON_USEDEP}]
	>=dev-py/platformdirs-4.3.8[${PYTHON_USEDEP}]
	>=dev-py/pyproject-hooks-1.2.0[${PYTHON_USEDEP}]
	>=dev-py/requests-2.32.4[${PYTHON_USEDEP}]
	>=dev-py/rich-14.1.0[${PYTHON_USEDEP}]
	>=dev-py/resolvelib-1.2.0[${PYTHON_USEDEP}]
	>=dev-py/setuptools-70.3.0[${PYTHON_USEDEP}]
	>=dev-py/tomli-w-1.2.0[${PYTHON_USEDEP}]
	>=dev-py/truststore-0.10.1[${PYTHON_USEDEP}]
	>=dev-py/typing-extensions-4.13.2[${PYTHON_USEDEP}]
"
BDEPEND="
	${RDEPEND}
	test? (
		$(python_gen_cond_dep '
			dev-py/ensurepip-setuptools
			...
			dev-py/scripttest[${PYTHON_USEDEP}]
			>=dev-py/setuptools-70.1.0[${PYTHON_USEDEP}]
			dev-py/virtualenv[${PYTHON_USEDEP}]
			dev-py/werkzeug[${PYTHON_USEDEP}]
			test-rust? (
...
python_configure() {
	if use test && has_version "dev-py/pip[${PYTHON_USEDEP}]"; then
		"${EPYTHON}" -m pip check ||
