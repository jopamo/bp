...
RDEPEND="
	...
	dev-pypi/jaraco-collections[${PYTHON_USEDEP}]
	dev-pypi/jaraco-functools[${PYTHON_USEDEP}]
	>=dev-pypi/jaraco-text-3.7.0-r1[${PYTHON_USEDEP}]
	>=dev-pypi/more-itertools-8.12.0-r1[${PYTHON_USEDEP}]
	>=dev-pypi/packaging-24[${PYTHON_USEDEP}]
	>=dev-pypi/platformdirs-2.6.2-r1[${PYTHON_USEDEP}]
	>=dev-pypi/wheel-0.44.0[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		>=dev-pypi/tomli-2.0.1[${PYTHON_USEDEP}]
	' 3.10)
...
BDEPEND="
	...
	test? (
		$(python_gen_cond_dep '
			>=dev-pypi/build-1.0.3[${PYTHON_USEDEP}]
			>=dev-pypi/ini2toml-0.14[${PYTHON_USEDEP}]
			>=dev-pypi/filelock-3.4.0[${PYTHON_USEDEP}]
			>=dev-pypi/jaraco-envs-2.2[${PYTHON_USEDEP}]
			>=dev-pypi/jaraco-path-3.2.0[${PYTHON_USEDEP}]
			...
			>=dev-pypi/pytest-home-0.5[${PYTHON_USEDEP}]
			dev-py/pytest-subprocess[${PYTHON_USEDEP}]
			dev-pypi/pytest-timeout[${PYTHON_USEDEP}]
			dev-pypi/pytest-xdist[${PYTHON_USEDEP}]
			>=dev-pypi/tomli-w-1.0.0[${PYTHON_USEDEP}]
			>=dev-pypi/virtualenv-20[${PYTHON_USEDEP}]
		' "${PYTHON_TESTED[@]}")
	)
"
...
PDEPEND="
	...
	>=dev-pypi/trove-classifiers-2024.10.16[${PYTHON_USEDEP}]
"
