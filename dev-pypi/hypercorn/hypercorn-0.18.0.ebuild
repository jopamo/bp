...
RDEPEND="
	dev-pypi/h11[${PYTHON_USEDEP}]
	>=dev-pypi/h2-4.3.0[${PYTHON_USEDEP}]
	dev-py/priority[${PYTHON_USEDEP}]
	>=dev-pypi/wsproto-0.14.0[${PYTHON_USEDEP}]
"
BDEPEND="
	test? (
		dev-pypi/httpx[${PYTHON_USEDEP}]
		>=dev-pypi/trio-0.22.0[${PYTHON_USEDEP}]
	)
"
