...
RDEPEND="
	>=dev-py/iniconfig-1.0.1[${PYTHON_USEDEP}]
	>=dev-py/packaging-22[${PYTHON_USEDEP}]
	<dev-py/pluggy-2[${PYTHON_USEDEP}]
	>=dev-py/pluggy-1.5.0[${PYTHON_USEDEP}]
	>=dev-py/pygments-2.7.2[${PYTHON_USEDEP}]
"
BDEPEND="
	...
	test? (
		${RDEPEND}
		$(python_gen_cond_dep '
			dev-py/argcomplete[${PYTHON_USEDEP}]
			>=dev-py/attrs-19.2[${PYTHON_USEDEP}]
			>=dev-py/hypothesis-3.56[${PYTHON_USEDEP}]
			dev-py/mock[${PYTHON_USEDEP}]
			dev-py/pytest-xdist[${PYTHON_USEDEP}]
			dev-py/requests[${PYTHON_USEDEP}]
			dev-py/xmlschema[${PYTHON_USEDEP}]
		' "${PYTHON_TESTED[@]}")
	)
"
