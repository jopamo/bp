...
RDEPEND="
	...
	>=dev-pypi/anyio-3.6.2[${PYTHON_USEDEP}]
	<dev-pypi/httpx-0.29[${PYTHON_USEDEP}]
	>=dev-pypi/httpx-0.22.0[${PYTHON_USEDEP}]
	dev-pypi/itsdangerous[${PYTHON_USEDEP}]
	dev-py/jinja[${PYTHON_USEDEP}]
	>=dev-pypi/python-multipart-0.0.18[${PYTHON_USEDEP}]
	dev-pypi/pyyaml[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		>=dev-pypi/typing-extensions-3.10.0[${PYTHON_USEDEP}]
	' 3.11)
"
BDEPEND="
	test? (
