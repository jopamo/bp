...
RDEPEND="
	>=dev-py/editables-0.3[${PYTHON_USEDEP}]
	>=dev-py/packaging-24.2[${PYTHON_USEDEP}]
	>=dev-py/pathspec-0.10.1[${PYTHON_USEDEP}]
	>=dev-py/pluggy-1.0.0[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		>=dev-py/tomli-1.2.2[${PYTHON_USEDEP}]
	' 3.10)
	dev-py/trove-classifiers[${PYTHON_USEDEP}]
"
BDEPEND="
	${RDEPEND}
	test? (
		$(python_gen_cond_dep '
			dev-py/atomicwrites[${PYTHON_USEDEP}]
			dev-py/click[${PYTHON_USEDEP}]
