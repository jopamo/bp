...
SNAPSHOT="63e63f3061287d2ce45dac05169616b16942a9c4"
...
IUSE="amdgpu arm +bpf bootstrap debug late nvptx stage test wasm xcore"
...
src_configure() {
	...
	if use bootstrap; then
		...
		mycmakeargs+=("${common[@]}" "${late[@]}")
	else
		mycmakeargs+=("${common[@]}" "${last[@]}")
	fi
