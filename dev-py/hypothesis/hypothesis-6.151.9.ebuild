...
RDEPEND="
	>=dev-py/sortedcontainers-2.1.0[${PYTHON_USEDEP}]
	cli? (
		$(python_gen_cond_dep '
			dev-py/black[${PYTHON_USEDEP}]
...
pkg_postinst() {
	optfeature "datetime support" dev-py/pytz
	optfeature "dateutil support" dev-py/python-dateutil
	optfeature "numpy support" dev-py/numpy
	optfeature "django support" "dev-py/django dev-py/pytz"
	optfeature "pandas support" dev-py/pandas
	optfeature "pytest support" dev-py/pytest
}
