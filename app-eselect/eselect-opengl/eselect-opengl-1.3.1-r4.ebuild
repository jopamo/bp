...
RDEPEND=">=sys-app/eselect-1.2.4
		 !<lib-media/mesa-10.3.4-r1
		 !=lib-media/mesa-10.3.5
		 !=lib-media/mesa-10.3.7-r1
		 !<x11/glproto-1.4.17-r1
		 !<=x11-app/xorg-server-1.12.4-r5
		 !=x11-app/xorg-server-1.15.2-r1
		 !=x11-app/xorg-server-1.15.2-r2
		 !~x11-app/xorg-server-1.16.3
		 !=x11-app/xorg-server-1.16.4
		 !=x11-app/xorg-server-1.16.4-r3
		 !~x11-app/xorg-server-1.17.0
		 !=x11-app/xorg-server-1.17.1
		 !<x11/ati-drivers-14.9-r2
		 !=x11/ati-drivers-14.12
		 !<=app-misc/emul-linux-x86-opengl-20140508"
