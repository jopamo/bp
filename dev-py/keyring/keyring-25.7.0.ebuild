...
RDEPEND="
	>=dev-py/secretstorage-3.2[${PYTHON_USEDEP}]
	dev-py/jaraco-classes[${PYTHON_USEDEP}]
	dev-py/jaraco-context[${PYTHON_USEDEP}]
	dev-py/jaraco-functools[${PYTHON_USEDEP}]
	>=dev-py/jeepney-0.4.2[${PYTHON_USEDEP}]
	$(python_gen_cond_dep '
		>=dev-py/importlib-metadata-4.11.4[${PYTHON_USEDEP}]
	' 3.11)
"
BDEPEND="
