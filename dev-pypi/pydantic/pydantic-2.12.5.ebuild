...
RDEPEND="
	>=dev-pypi/annotated-types-0.6.0[${PYTHON_USEDEP}]
	>=dev-pypi/typing-extensions-4.14.1[${PYTHON_USEDEP}]
	>=dev-pypi/typing-inspection-0.4.2[${PYTHON_USEDEP}]
	dev-pypi/tzdata[${PYTHON_USEDEP}]
	!dev-py/pydantic-core
"
BDEPEND="
	>=dev-pypi/hatch-fancy-pypi-readme-22.5.0[${PYTHON_USEDEP}]
	...
	test? (
		...
		>=dev-pypi/faker-18.13.0[${PYTHON_USEDEP}]
		>=dev-pypi/jsonschema-4.23.0[${PYTHON_USEDEP}]
...
python_test() {
	...
	if ! has_version "dev-pypi/cloudpickle[${PYTHON_USEDEP}]"; then
		EPYTEST_IGNORE+=(
			# (pydantic)
