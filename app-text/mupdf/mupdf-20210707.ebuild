...
LIB_DEPEND="
	...
	X? ( x11-live-libs/libX11[static-libs?]
		x11-live-libs/libXext[static-libs?] )
"
RDEPEND="${LIB_DEPEND}"
DEPEND="${RDEPEND}
	lib-media/freeglut
	...
	static? ( ${LIB_DEPEND//?}
		...
		x11-live-libs/libXau[static-libs]
		x11-live-libs/libXdmcp[static-libs]
		lib-gui/libxcb[static-libs] )"
