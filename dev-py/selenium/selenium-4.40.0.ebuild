...
RDEPEND="
	>=dev-py/certifi-2026.1.4[${PYTHON_USEDEP}]
	>=dev-py/trio-0.31.0[${PYTHON_USEDEP}]
	>=dev-py/trio-websocket-0.12.2[${PYTHON_USEDEP}]
	>=dev-py/typing-extensions-4.15.0[${PYTHON_USEDEP}]
	>=dev-py/urllib3-2.6.0[${PYTHON_USEDEP}]
	>=dev-py/websocket-client-1.8.0[${PYTHON_USEDEP}]
"
BDEPEND="
	test? (
		${RDEPEND}
