...
RDEPEND="
	>=dev-py/comm-0.1.1[${PYTHON_USEDEP}]
	>=dev-py/ipython-7.23.1[${PYTHON_USEDEP}]
	>=dev-py/jupyter-client-8.0.0[${PYTHON_USEDEP}]
	>=dev-py/jupyter-core-4.12[${PYTHON_USEDEP}]
	>=dev-py/matplotlib-inline-0.1[${PYTHON_USEDEP}]
	>=dev-py/nest-asyncio-1.4[${PYTHON_USEDEP}]
	>=dev-py/packaging-22[${PYTHON_USEDEP}]
	>=dev-py/psutil-5.7[${PYTHON_USEDEP}]
	>=dev-py/pyzmq-25[${PYTHON_USEDEP}]
	>=dev-py/tornado-6.2[${PYTHON_USEDEP}]
	>=dev-py/traitlets-5.4.0[${PYTHON_USEDEP}]
"
...
BDEPEND="
	${RDEPEND}
	test? (
		dev-py/ipyparallel[${PYTHON_USEDEP}]
