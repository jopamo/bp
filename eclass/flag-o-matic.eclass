	...
	for f in "$@" ; do
		case "${f}" in
			...
			-D_GLIBCXX_ASSERTIONS|-D_GLIBCXX_ASSERTIONS=*)
				tc-enables-libstdcxx-assertions && append-cppflags -U_GLIBCXX_ASSERTIONS
				;;
			-D_LIBCPP_ENABLE_ASSERTIONS|-D_LIBCPP_ENABLE_ASSERTIONS=*|-D_LIBCPP_HARDENING_MODE=*|-D_LIBCPP_ENABLE_HARDENED_MODE|-D_LIBCPP_ENABLE_HARDENED_MODE=*)
				tc-enables-libcxx-assertions && append-cppflags -U_LIBCPP_ENABLE_ASSERTIONS -U_LIBCPP_HARDENING_MODE -U_LIBCPP_ENABLE_HARDENED_MODE
				;;
			-D_FORTIFY_SOURCE=*)
...
filter-clang() {
	...
	filter-flags -fuse-linker-plugin '-D_FORTIFY_SOURCE*' '-D_GLIBCXX_ASSERTIONS*' '-D_LIBCPP_ENABLE_ASSERTIONS*' '-D_LIBCPP_HARDENING_MODE=*' '-D_LIBCPP_ENABLE_HARDENED_MODE*' '-Wl,-z,combreloc' '-Wl,-z,defs' '-Wl,-z,now';
