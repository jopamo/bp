...
RDEPEND="
	>=dev-py/fastjsonschema-2.21.2[${PYTHON_USEDEP}]
	>=dev-py/lark-1.3.1[${PYTHON_USEDEP}]
...
BDEPEND="
	...
	test? (
		$(python_gen_cond_dep '
			...
			>=dev-py/trove-classifiers-2022.5.19[${PYTHON_USEDEP}]
			>=dev-py/virtualenv-20.21[${PYTHON_USEDEP}]
		' "${PYTHON_TESTED[@]}")
	)
"
